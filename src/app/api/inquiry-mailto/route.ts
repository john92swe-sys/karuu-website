...
const fieldLabels: Record<string, string> = {
  ...
  instructorStaffWear: 'Instructor or Staff Wear',
  memberRetail: 'Member Retail',
  teacherTraining: 'Teacher Training',
  privateLabel: 'Private Label',
  phone: 'WhatsApp / Phone',
  estimatedQuantity: 'Estimated Total Quantity',
  preferredProductCategories: 'Preferred Product Categories',
  representativeStyles: 'Selected Representative Styles',
