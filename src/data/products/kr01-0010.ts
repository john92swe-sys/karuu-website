...
export const kr010010: Product = {
  ...
  description:
    'Factory style DF002 combines lightweight stretch fabric with a high-rise waist, rear ruched shaping, two buttoned back pockets, and a flared-leg silhouette. The supplied specification lists 80% polyester and 20% elastane, with sizes S to XL. Designed for yoga, exercise, daily wear, and loungewear.',
  features: [
  ...
  gallery: [
    ...
    },
    {
      ...
      alt: 'Buttoned back pocket and ruched shaping detail for factory style DF002',
      width: 1200,
      height: 1600,
      kind: 'detail',
    },
    {
      ...
      alt: 'Lightweight stretch fabric detail for factory style DF002',
      width: 1200,
      height: 1600,
      kind: 'detail',
    },
  ...
  seo: {
    ...
    description:
      'Explore KARUU KR01-0010, factory style DF002 high-waist cargo flared yoga pants with rear ruched shaping, buttoned pockets, and stretch fabric.',
