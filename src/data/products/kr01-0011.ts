...
export const kr010011: Product = {
  ...
  description:
    'Factory style 6501 is a cropped halter active top made from 90% polyamide and 10% elastane. The design combines a halter neckline, open back, removable breathable pads, widened side panels, and a close fit for yoga, gym training, running, and everyday styling.',
  features: [
  ...
  gallery: [
    ...
    },
    {
      ...
      alt: 'Removable pad and support detail for factory style 6501',
      width: 1400,
      height: 1866,
      kind: 'detail',
    },
    {
      ...
      alt: 'Open-back halter design detail for factory style 6501',
      width: 1400,
      height: 1400,
      kind: 'detail',
    },
  ...
  seo: {
    ...
    description:
      'Explore KARUU KR01-0011, factory style 6501, a cropped French halter active top with removable pads and four-way stretch for B2B sourcing and OEM/ODM discussions.',
