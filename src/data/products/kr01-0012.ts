...
export const kr010012: Product = {
  ...
  description:
    'Factory style 6501 is a seamless cropped short-sleeve active T-shirt made from 90% polyamide and 10% elastane. The soft four-way stretch fabric, breathable quick-dry performance, crew neckline, and fitted cropped silhouette support yoga, running, gym training, and everyday activewear styling.',
  features: [
  ...
  gallery: [
    ...
    },
    {
      ...
      alt: 'Seamless knit construction detail for factory style 6501',
      width: 1400,
      height: 2100,
      kind: 'detail',
    },
    {
      ...
      alt: 'Four-way stretch fabric detail for factory style 6501',
      width: 1400,
      height: 2100,
      kind: 'detail',
    },
  ...
  seo: {
    ...
    description:
      'Explore KARUU KR01-0012, factory style 6501 seamless cropped short-sleeve active T-shirt with four-way stretch and quick-dry performance.',
